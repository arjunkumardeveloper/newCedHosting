                 ...
                 <div class="register-top-grid">
                    ...
                    <p class="requireField">* Required Field</p>
                     ...
                     <div>
                         ...
                         data-toggle="arjun" title="email@gmail.com"> 
                     </div>
                     <div>
                         <span>Contact No.<label>*</label>
                          (Minimum 10 digits required)</span>
                         <input type="text" id="mobile" name="mobile" 
                         title="Minimum Ten(10) digits required and all value 
                     ...
                     <div>
                         ...
                         <select name="squestion" id="squestion">
                             ...
                             childhood friend?">What is the name of your favourite 
                             childhood friend?</option>
                             <option value="What was your favourite place to visit 
                             as a child?">What was your favourite place to visit as 
                             a child?</option>
                             <option value="What was your dream job as a child?">
                             What was your dream job as a child?</option>
                             <option 
                             value="What is your favourite teacher's nickname?">
                            ...
                            <h3>login information</h3>
                             <div>
                                ...
                                <input type="password" id="password" name="password"
                                 data-toggle="arjun" 
                                 title="Password: Combination of UPPERCASE,
                                  lowercase, special character,
                                   numeric and Range between 8-16 character !">
                             </div>
                             <div>
                                <span>Confirm Password<label>*</label></span>
                                <input type="password" id="conpassword" 
                                name="conpassword" data-toggle="arjun" 
                                title="Password: Combination of UPPERCASE, 
                                lowercase, special character, 
                                numeric and Range between 8-16 character !">
                             </div>
